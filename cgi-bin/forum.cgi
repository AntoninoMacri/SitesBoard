...
print <<SECONDA_PARTE;
			...
			<div id="path" title="Sezione del sito in cui ti trovi in questo momento">
				Ti trovi in: <span class="notable" xml:lang="en" lang="en"><a href="home.cgi" hreflang="it" type="text/html">Home</a></span> &gt;&gt; <span class="notable">Bacheca Forum</span>
			</div>
			...
			<div id="nav_panel">
				...
				<div id="nav_menu" class="menu" title ="Menù di navigazione del sito">
					...
					<ul>
						...
						<li  class="current_pageL">Tipologia <span xml:lang="en" lang="en">Forum</span></li>
...
if($index_precedente>=0 && $index ne 0){
	print "<a href='forum.cgi?index=$index_precedente' class='BI_PN' hreflang='it' type='application/xhtml+xml'>Precedente</a>";
}

if($index_successivo<$size){
	print "<a href='forum.cgi?index=$index_successivo' class='BI_PN' hreflang='it' type='application/xhtml+xml'>Successiva</a>";
}

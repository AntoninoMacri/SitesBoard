...
if($index_precedente>=0 && $index ne 0){
	print "<a href='forum.cgi?index=$index_precedente' hreflang='it' type='application/xhtml+xml'>Precedente</a>";
}

if($index_successivo<$size){
	print "<a href='forum.cgi?index=$index_successivo' hreflang='it' type='application/xhtml+xml'>Successiva</a>";
}

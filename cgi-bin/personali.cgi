...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	<head>
		<title>Personali - SitesBoard</title> 
		...
		<meta name="title" content="Siti Personali - SitesBoard" />
		<meta name="author" content="Davide Rigoni, Francesco Fasolato, Giacomo Zecchin, Antonino Macrì" />
		<meta name="description" content="Bacheca di siti Personali di SitesBoard per la richiesta di Siti Web Professionali" />
		<meta name="keywords" content="Siti, Personali, Bacheca, Siti, Web" />
...
print <<SECONDA_PARTE;
			...
			<div id="path" title="Sezione del sito in cui ti trovi in questo momento">
				Ti trovi in: <span class="notable" xml:lang="en" lang="en"><a href="home.cgi" hreflang="it" type="text/html">Home</a></span> &gt;&gt; <span class="notable">Bacheca Personali</span>
			</div>
			...
			<div id="nav_panel">
				...
				<div id="nav_menu" class="menu" title ="Menù di navigazione del sito">
					...
					<ul>
						...
						<li  class="current_pageL">Tipologia Personali</li>
...
print <<FINE;
			...
			<div id="contents">
				<h3><span xml:lang="en" lang="en">Personali</span></h3>
				<div id="cont_personali">
				<p class="underline">Ecco gli annunci disponibili per la tipologia Personali.</p>
...
if($index_precedente>=0 && $index ne 0){
	print "<a href='personali.cgi?index=$index_precedente' class='BI_PN' hreflang='it' type='application/xhtml+xml'>Precedente</a>";
}

if($index_successivo<$size){
	print "<a href='personali.cgi?index=$index_successivo' class='BI_PN' hreflang='it' type='application/xhtml+xml'>Successiva</a>";
}

...
print <<SECONDA_PARTE;
			...
			<div id="path" title="Sezione del sito in cui ti trovi in questo momento">
				Ti trovi in: <span class="notable" xml:lang="en" lang="en"><a href="home.cgi" hreflang="it" type="application/xhtml+xml">Home</a></span> &gt;&gt; <span class="notable">Bacheca Personali</span>
			</div>
			...
			<div id="nav_panel">
				...
				<div id="nav_menu" class="menu" title ="Menù di navigazione del sito">
					...
					<ul>
						...
						<li><a href="forum.cgi" hreflang="it" >Personali</a></li>
						<li><a href="social.cgi" hreflang="it" ><span xml:lang="en" lang="en">Social</span></a></li>
						<li><span class="current_pageL" xml:lang="en" lang="en">Personali</span></li>

			...
			<div id="nav_panel">
				...
				<div id="nav_menu" class="menu" title ="Menù di navigazione del sito">
					...
					<ul>
						...
						<li  class="current_pageL"><span xml:lang="en" lang="en">Tipologia Social</span></li>
...
if($index_precedente>=0 && $index ne 0){
	print "<a href='social.cgi?index=$index_precedente' id='BI_PN' hreflang='it' type='application/xhtml+xml'>Precedente</a>";
}

if($index_successivo<$size){
	print "<a href='social.cgi?index=$index_successivo' id='BI_PN' hreflang='it' type='application/xhtml+xml'>Successiva</a>";
}
